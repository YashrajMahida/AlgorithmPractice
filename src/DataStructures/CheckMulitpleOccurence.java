 ...
 * Time Complexity of the above hashing based solution is Θ(n) under the assumption that insert,
 * search and delete operations on HashMap take O(1) time.
 *
 */
public class CheckMulitpleOccurence {
