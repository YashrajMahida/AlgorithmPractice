...
public class ChallengeCoverLetter {
    ...
    public  boolean checkEMAIL(String email){
        ...
        Pattern pattern = Pattern.compile("^([\\!#\\$%&'\\*\\+/\\=?\\^`\\{\\|\\}~a-zA-Z0-9_-]+[" +
                "\\.]?)+[\\!#\\$%&'\\*\\+/\\=?\\^`\\{\\|\\}~a-zA-Z0-9_-]+" +
                "@{1}((([0-9A-Za-z_-]+)([\\.]{1}[0-9A-Za-z_-]+)*\\.{1}([A-Za" +
                "-z]){1,6})|(([0-9]{1,3}[\\.]{1}){3}([0-9]{1,3}){1}))$");
    ...
    public static void main(String[] args) throws Exception {
        ChallengeCoverLetter challengeCoverLetter = new ChallengeCoverLetter();
